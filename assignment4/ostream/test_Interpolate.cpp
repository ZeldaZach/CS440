...
main(int argc, char **argv) {
    ...
    // Test std::put_money().
    {
        ...
        CS540_TEST("$1.12, USD  1.12", ss.str());
    }
    // Test std::put_time().
    {
        std::stringstream ss;
        ...
        ss << Interpolate("%, %", std::put_time(&tm, "%c %Z"), std::put_time(&tm2, "%c %z"));
        // std::cout << ss.str() << std::endl;
        CS540_TEST("Mon 02 May 2016 01:53:44 PM EDT EDT, Mon 02 May 2016 01:53:01 PM EDT +0000 Mon May  2 13:53:44 2016 EDT, Mon May  2 13:53:01 2016 +0000", ss.str());
    }
    ...
    // Verify that the operations are applied to the actual ostream.
    {
        ...
        ss << " " << 0567;
        // std::cout << ss.str() << std::endl;
        CS540_TEST("11 0xabc 0xaa 123 0567", ss.str());
    }
